...
import { SurplusDialog } from './surplus-dialog'
  ...
  return (
    <>
      <nav
        ...
        className="fixed inset-x-0 bottom-[calc(3.75rem+env(safe-area-inset-bottom))] z-40 border-t border-accent/20 bg-primary/95 backdrop-blur lg:bottom-0"
      >
