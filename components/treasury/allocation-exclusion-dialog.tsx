  ...
  return (
    <DialogShell title="استبعاد مشروع من توزيع التشغيل" onClose={onClose}>
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label htmlFor="exclusion-month" className="mb-1 block text-sm font-semibold text-ink">
            الشهر (السنة-الشهر)
          </label>
          <input
            id="exclusion-month"
        ...
        <div>
          <label htmlFor="exclusion-project" className="mb-1 block text-sm font-semibold text-ink">
            المشروع
          </label>
          <select
        ...
        <div>
          <label htmlFor="exclusion-reason" className="mb-1 block text-sm font-semibold text-ink">
            السبب (اختياري)
          </label>
          <input
            id="exclusion-reason"
