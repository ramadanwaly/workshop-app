...
export default async function SettingsPage() {
  ...
  if (!user) {
    return (
      <main className="min-h-screen p-8">
        <h1 className="mb-4 text-2xl font-bold text-destructive">غير مصرح</h1>
        <p className="text-muted-foreground">يرجى تسجيل الدخول للوصول إلى صفحة الإعدادات.</p>
      </main>
    )
  }
  ...
  if (profile?.role !== 'owner') {
    return (
      <main className="min-h-screen p-8">
        <h1 className="mb-4 text-2xl font-bold text-destructive">غير مصرح</h1>
        <p className="text-muted-foreground">صفحة الإعدادات مخصصة لمالك الورشة فقط.</p>
      </main>
    )
  }
  ...
  return (
    <main className="min-h-screen">
      ...
      <div className="mx-auto max-w-5xl px-4 py-6 sm:px-6 sm:py-8 space-y-6">
        <div>
          <h1 className="text-xl font-bold text-foreground sm:text-2xl">إعدادات النظام والتحكم</h1>
